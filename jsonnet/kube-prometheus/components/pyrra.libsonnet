      ...
      indicator: {
        latency: {
          success: {
            ...
            metric: 'apiserver_request_slo_duration_seconds_bucket{job="apiserver",scope=~"resource|",verb=~"LIST|GET",subresource!~"/(healthz|livez|readyz)",le="0.1"}',
          },
          total: {
            // metric: 'apiserver_request_duration_seconds_count{job="apiserver",scope=~"resource|",verb=~"LIST|GET"}',
            metric: 'apiserver_request_slo_duration_seconds_count{job="apiserver",scope=~"resource|",verb=~"LIST|GET",subresource!~"/(healthz|livez|readyz)"}',
          },
        },
      },
    },
      ...
      indicator: {
        latency: {
          success: {
            ...
            metric: 'apiserver_request_slo_duration_seconds_bucket{job="apiserver",scope=~"namespace|",verb=~"LIST|GET",subresource!~"/(healthz|livez|readyz)",le="5"}',
          },
          total: {
            //metric: 'apiserver_request_duration_seconds_count{job="apiserver",scope=~"namespace|",verb=~"LIST|GET"}',
            metric: 'apiserver_request_slo_duration_seconds_count{job="apiserver",scope=~"namespace|",verb=~"LIST|GET",subresource!~"/(healthz|livez|readyz)"}',
          },
        },
      },
    },
      ...
      indicator: {
        latency: {
          success: {
            ...
            metric: 'apiserver_request_slo_duration_seconds_bucket{job="apiserver",scope=~"cluster|",verb=~"LIST|GET",subresource!~"/(healthz|livez|readyz)",le="5"}',
          },
          total: {
            //metric: 'apiserver_request_duration_seconds_count{job="apiserver",scope=~"cluster|",verb=~"LIST|GET"}',
            metric: 'apiserver_request_slo_duration_seconds_count{job="apiserver",scope=~"cluster|",verb=~"LIST|GET",subresource!~"/(healthz|livez|readyz)"}',
          },
        },
      },
    },
  ...
  'slo-prometheus-rule-evaluation-failures': {
    ...
    metadata: {
      ...
      labels: {
        prometheus: 'k8s',
        role: 'alert-rules',
        'pyrra.dev/component': 'prometheus',
      },
    },
    spec: {
      target: '99.99',
...
// 1000 * histogram_quantile(0.99, rate(kubelet_runtime_operations_duration_seconds_bucket{operation_type="list_containers"}[5m]))
// rate(kubelet_runtime_operations_duration_seconds_count[5m])
